...
function numberOfBlackRectangles(field) {
    let counter = 0;
...
function clearRectangle(field, row, col) {
...
function similarInTwoArrays(arr1, arr2, arr3) {
    let result = [];
...
function isExistOnlyInOneArr(elem, arr1, arr2) {
